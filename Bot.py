...
# ================== СЛОВАРЬ ПАРОЛЕЙ (упрощённый для скорости) ==================
PASSWORDS = [
...
def cmd_auto_mass(message):
    ...
    # Здесь можно запустить в отдельном потоке, но для простоты оставим синхронно
    generated = set()
    ...
    with ThreadPoolExecutor(max_workers=20) as executor:
        futures = {executor.submit(brute_single, email): email for email in existing[:100]}  # ограничим для примера
